...
public class Principal {
    ...
    private void imprimirResultadosTriangulo(byte opcion) {
        switch (opcion) {
            case 1:
                ...
                System.out.println("Perimetro Triangulo: " + triangulo.getPerimetro());
                break;
            case 2:
    ...
    /**
     * Imprime los resultados de la opcion escogida
     *
     * @param opcion
     */
    private void imprimirResultadosCuadrado(byte opcion) {
        switch (opcion) {
            case 1:
                ...
                System.out.println("Perimetro Cuadrado: " + cuadrado.getPerimetro());
                break;
            case 2:
